...
export class CartItemComponent implements OnInit {
  ...
  constructor(private router:ActivatedRoute,private cservice:CartService, private pserice:MedicineService, private uservice:UserService, private rout:Router) { }
